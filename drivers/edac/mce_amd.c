...
static const char * const smca_nbio_mce_desc[] = {
	"ECC or Parity error. An SRAM ECC or parity error was detected",
	"PCIE error. A PCIe error was logged in a PCIe root port",
	"SDP ErrEvent error. A system fatal error event from data fabric was detected",
	"SDP Egress Poison Error. Poison was propagated to an egress port",
};
...
static const char * const smca_pcie_mce_desc[] = {
	...
	"CCIX Non-okay write reponse with data error",
};
