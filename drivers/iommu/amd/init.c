 ...
 * (i.e. before PCI init).
 */
static void early_iommu_features_init(struct amd_iommu *iommu, u64 efr)
{
...
static int __init init_iommu_one(struct amd_iommu *iommu, struct ivhd_header *h)
{
	...
	case 0x40:
		...
		early_iommu_features_init(iommu, h->efr_reg);
...
static void __init ivinfo_init(u8 *ivrs)
{
