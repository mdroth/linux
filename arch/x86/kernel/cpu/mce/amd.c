...
static struct smca_hwid smca_hwid_mcatypes[] = {
	...
	/* MPIO Unit MCA type
	 * TODO : BUG: Overloaded with SMU */
	{ SMCA_MPIO,	 HWID_MCATYPE(0x01, 0x1)	},
	...
	/* xGMI PCS MCA type
	 * TODO : Erratum: HWID will be 0x80 in HW */
