...
/* Applies to some Family 19h models only */
#define AMD64_F19H_EVENTSEL_EVENT_NB	\
	(AMD64_EVENTSEL_EVENT	|	\
	 GENMASK_ULL(37, 36))

#define AMD64_F19H_EVENTSEL_UMASK_NB		\
	(ARCH_PERFMON_EVENTSEL_UMASK	|	\
	 GENMASK_ULL(27, 24))

#define AMD64_F19H_RAW_EVENT_MASK_NB		\
	(AMD64_F19H_EVENTSEL_EVENT_NB	|	\
	 AMD64_F19H_EVENTSEL_UMASK_NB)
